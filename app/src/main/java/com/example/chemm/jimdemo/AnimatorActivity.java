...
public class AnimatorActivity extends BaseActivity {
    ...
    public void trans(){
        ObjectAnimator animator = ObjectAnimator.ofFloat(tv, "translationX", 0, 100, -200,0,100); //translationY
    ...
    public void color(){
        ObjectAnimator animator = ObjectAnimator.ofInt(tv, "BackgroundColor", 0xff7f00ff, 0xffffff00, 0xffff00ff);
